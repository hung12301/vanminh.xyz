...
if($now['hours']>=18){
        $disable = true;
        $thongbao = 'Hiện tại đã quá 18h.Chức năng ghi đề đang đóng và sẽ mở lại vào lúc 0h ngày mai.Xin cảm ơn !';
}
...
require '../views/lode/ghide.tpl.php';
?>