<?php require_once ROOT . '/app/view/layout/header.php' ?>
    ...
    <div class="signup-box">
        <div class="logo">
            <a href="<?= SITE_URL ?>">VANMINH<b>.XYZ</b></a>
            <small>Facebook Marketing Tools</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST">
                    <div class="msg">Đăng ký sử dụng hệ thống Facebook Marketing của chúng tôi ! Bạn sẽ có 7 ngày dùng thử</div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">person</i>
                        </span>
                        <div class="form-line">
                            <input type="text" class="form-control" name="name" placeholder="Họ và tên" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
